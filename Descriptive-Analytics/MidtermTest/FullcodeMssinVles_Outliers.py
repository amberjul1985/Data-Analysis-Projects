...
Q1 = df_median_filled['salary'].quantile(0.25)
Q3 = df_median_filled['salary'].quantile(0.75)
IQR = Q3 - Q1
...
print(df_median_filled['salary'] < lower_bound)
outliers = df_median_filled[(df_median_filled['salary'] < lower_bound) | (df_median_filled['salary'] > upper_bound)]
...
df_no_out = df_median_filled[(df_median_filled['salary'] >= lower_bound) & (df_median_filled['salary'] <= upper_bound)]
...
# print("\nDescriptive statistics for 'salary' after cleaning:")
# print(df_no_out['salary'].describe())
# print("Skewness of 'salary' after cleaning:", df_no_out['salary'].skew())
# print("Kurtosis of 'salary' after cleaning:", df_no_out['salary'].kurtosis())
...
# Histogram for 'salary'
plt.hist(df_no_out['salary'].dropna(), bins=20)
plt.title('Salary Distribution')
plt.xlabel('Salary')
plt.ylabel('Frequency')
plt.show()
